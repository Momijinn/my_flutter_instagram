...
class _$AppStateTearOff {
  ...
  _AppState call({List<Map<String, dynamic>> imageList = const []}) {
    return _AppState(
      imageList: imageList,
    );
  }
...
class _$_AppState implements _AppState {
  const _$_AppState({this.imageList = const []});
...
abstract class _AppState implements AppState {
  const factory _AppState({List<Map<String, dynamic>> imageList}) = _$_AppState;
